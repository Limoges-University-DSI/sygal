...
class ValidationPageDeCouvertureNotificationDirecteur extends Notification
{
    use TheseAwareTrait;
    ...
    protected $templatePath = 'application/notification/mail/notif-validation-page-couverture-directeur';
    ...
    public function prepare()
    {
        ...
        $to = $this->these->getDirecteursTheseEmails($individusSansMail);
        ...
        $this
            ...
            ->setSubject( "Page de couverture de la thèse de " . $this->these->getDoctorant() )
            ->setTo($to)
