...
class ValidationPageDeCouvertureNotificationDoctorant extends Notification
{
    use TheseAwareTrait;
    ...
    protected $templatePath = 'application/notification/mail/notif-validation-page-couverture-doctorant';
    ...
    public function prepare()
    {
        ...
        $infoMessage = sprintf(
            "Un mail de notification vient d'être envoyé au doctorant et au(x) directeur(s) de thèse (%s)",
            $to,
            implode(',', $cc)
        );
